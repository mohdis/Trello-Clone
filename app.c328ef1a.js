...
function addCardToList(card, listID) {
...
var debouncedHandleSearch = (0, _lodash.default)(showListsWithFilter, 500);
...
function handleSubmitCardDialog(e) {
  ...
  if (selectedCardID) {
    ...
    (0, _localStorage.addCardToList)(card, selectedListID);
  }

  showLists();
  closeCardDialogAndCleanup();
}
},{"lodash.debounce":"../node_modules/lodash.debounce/index.js","./utils":"utils.js","./localStorage":"localStorage.js","./ui":"ui.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
